...
/**
 * Returns role grants that exist on an enrollment.
 *
 * Requires the `control-panel:enrollment:view-role-grants` operation on the enrollment RID, which itself should
 * be acquired through a role grant.
 */
export async function getEnrollmentRoleGrants(
  ctx: ConjureContext,
