...
import type { GetEnrollmentHostsResponseDeprecated } from "../GetEnrollmentHostsResponseDeprecated.js";
 ...
 */
export async function getEnrollmentHostsDeprecated(
  ctx: ConjureContext,
  enrollmentRid: EnrollmentRid,
): Promise<GetEnrollmentHostsResponseDeprecated> {
  return conjureFetch(ctx, `/admin/enrollment/${enrollmentRid}/hosts`, "GET");
}
