...
/**
 * Returns whether MFA can be configured.
 *
 ...
 */
export async function deprecatedIsMfaEnabledWithEnrollmentSetupToken(
  ctx: ConjureContext,
  ...
  return conjureFetch(
    ctx,
    `/mfa/enrollments/${enrollmentRid}/enabled/enrollment-setup-token`,
    "GET",
  );
}
