 ...
 *
 * To add rules for a provider, provide a `GroupRules` object with additional rules in the `rules` field.
 *
 * To delete rules for a provider, provide a `GroupRules` object with rules removed from the `rules` field.
 *
