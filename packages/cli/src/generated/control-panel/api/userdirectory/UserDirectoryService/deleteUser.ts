...
/**
 * Deletes the specified user from the user directory. If the specified user
 * does not exist in the user directory, does nothing.
 *
 * The user will be deleted synchronously on both Multipass and the user directory.
 *
 * Throws:
